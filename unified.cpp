...
int main() {
  ...
  std::cout << "Memory before OpenCL initialization" << "\n";
  ...
  std::cout << "Memory after OpenCL initialization and allocation" << "\n";
  res_kb = get_resident_set_size_kb();
  pss_kb = get_current_process_pss_kb();
  std::cout << "  RSS (RES): " << GREEN << res_kb << " kB" << RESET 
        << " (" << GREEN << (res_kb / 1024.0) << " MB" << RESET << ")" << "\n";
  ...
  clFinish(queue);
  std::cout << "Memory after OpenCL invoke" << "\n";
  res_kb = get_resident_set_size_kb();
  pss_kb = get_current_process_pss_kb();
  std::cout << "  RSS (RES): " << GREEN << res_kb << " kB" << RESET 
        << " (" << GREEN << (res_kb / 1024.0) << " MB" << RESET << ")" << "\n";
  ...
  std::cout << "Memory after CPU data read" << "\n";
  res_kb = get_resident_set_size_kb();
  pss_kb = get_current_process_pss_kb();
  std::cout << "  RSS (RES): " << GREEN << res_kb << " kB" << RESET 
        << " (" << GREEN << (res_kb / 1024.0) << " MB" << RESET << ")" << "\n";
